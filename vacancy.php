...
<div class ="ann">
	...
	<br>
	<p >Harbu Micro Finance S.C wants to recruit professional forthe following Vacant Positions:-Interested applicants who meet the below requirements are invited to submit their application letter & CV along with nonreturnable credentials with 7 (seven) working days from this announcement to Human Resource & Administration Office Bole,near Atlas Hotel or submit through our email address at <a class="active" href="home.php">Harbumfi@gmail.com</a>  or apply through our online Application by Clicking <a href="https://docs.google.com/forms/d/e/1FAIpQLSd4fwlYCFmlwYVoh5Jhef8x1KGC0_AUNGDFPj270XKNrJJNbw/viewform">apply</a> link.</p>
<?php  
	include_once 'db.php';
...
<tr>
	...
	<td ><a href="https://docs.google.com/forms/d/10gfoZk3XhLh8la_6-nRYckHOZ-9cYtUfpFSGvxVfjxM/edit">apply</a></td>
</tr>
<?php
$i++;
}
